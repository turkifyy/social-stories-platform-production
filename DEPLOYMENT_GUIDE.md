...
- [ ] تم إضافة `APP_URL` في GitHub Secrets.
- [ ] تم إضافة `CRON_SECRET_KEY` في GitHub Secrets.
- [ ] تم تفعيل تطبيق Render وربط المتغيرات (Env Vars).
- [ ] تم تفعيل GitHub Actions والتأكد من نجاح أول تشغيل (Run).